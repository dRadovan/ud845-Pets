...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    // Global uri variable received from intent that started the activity
    Uri mItemUri;

    // boolean to check if pet has changed
    private boolean mPetHasChanged = false;

    // OnTouchListener to listen for the changes made to the pet
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set the OnTouchListener on each view
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        // If cursor is null or it contains less than 1 rows return
    ...
    // method to show the dialog before exiting the activity
    ...
    // helper method to pop-up dialog when delete item is clicked in the menu
    ...
    private void deletePet() {
        int roesDeleted = getContentResolver().delete(mItemUri, null, null);
        if (roesDeleted > 0){
